      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-20 mb-32">
          <div className="flex-1 space-y-8">
            ...
            >
              Arbeiten Sie <span className="text-neon-500">nicht mehr</span> für Ihre Prozesse.
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <Link to="/booking">
                <button className="h-16 px-10 rounded-2xl bg-white text-dark-950 font-bold hover:bg-neon-500 transition-all flex items-center gap-3 active:scale-95">
                  Potenzial-Analyse
                  <ArrowRight size={20} />
                </button>
              </Link>
          ...
          <div className="flex-1 relative w-full lg:w-auto">
            ...
            >
              ...
              <div className="absolute inset-12 border border-neon-500/10 rounded-full" />
              
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-64 h-64 bg-neon-500/20 rounded-full blur-[100px]" />
                <div className="relative glass-card border-white/10 p-12 rounded-[3rem] shadow-2xl flex items-center justify-center">
                  <Bot size={80} className="text-neon-500" />
        ...
        <div className="mb-40">
          <div className="text-center mb-20 space-y-4">
            <h2 className="text-4xl md:text-5xl font-display font-bold text-white">Lösungen für Ihr <span className="text-neon-500">Wachstum</span></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {FEATURES.map((f, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="group glass-card p-10 rounded-[3rem] border-white/5 hover:border-neon-500/30 transition-all cursor-default"
              >
        ...
        <div className="mb-40 bg-dark-900 rounded-[4rem] p-12 md:p-24 border border-white/5 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-96 h-96 bg-neon-500/5 blur-[100px]" />
          
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div className="space-y-8">
              <h2 className="text-4xl md:text-5xl font-display font-bold text-white">In 3 Schritten zur <span className="text-neon-500">Automation</span></h2>
              ...
              <div className="space-y-12 pt-8">
                {[
                  ...
                  <div key={i} className="flex gap-6">
                    <div className="text-neon-500 font-display font-bold text-2xl">{s.step}</div>
            ...
            <div className="flex items-center justify-center">
              <div className="w-full aspect-square glass-card rounded-[3rem] border-white/10 p-8 relative">
                 <div className="absolute inset-0 bg-gradient-to-br from-neon-500/5 to-transparent rounded-[3rem]" />
                 <div className="relative space-y-6">
                    ...
                    {[1,2,3,4].map(i => (
                      <div key={i} className="h-12 bg-white/5 rounded-xl border border-white/5 flex items-center px-4 justify-between group overflow-hidden">
                        <div className="flex items-center gap-3">
                          <div className={`w-2 h-2 rounded-full ${i % 2 === 0 ? 'bg-neon-500' : 'bg-blue-500'}`} />
                          <div className="h-2 w-24 bg-white/10 rounded-full" />
                        </div>
                        <div className="h-2 w-12 bg-white/10 rounded-full" />
                        <motion.div 
                          className="absolute inset-0 bg-neon-500/10 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"
                        />
                      </div>
                    ))}
                    ...
                    <div className="pt-8 grid grid-cols-2 gap-4">
                      ...
                      <div className="h-24 bg-neon-500 rounded-2xl flex flex-col items-center justify-center gap-2">
        ...
        <div className="text-center max-w-4xl mx-auto space-y-12">
          <h2 className="text-5xl md:text-7xl font-display font-bold text-white">Bereit für das nächste <span className="text-neon-500">Level?</span></h2>
          ...
          <div className="flex justify-center gap-6">
            <Link to="/booking">
              <button className="h-20 px-12 rounded-[2rem] bg-neon-500 text-dark-950 font-bold text-lg hover:scale-105 transition-all shadow-[0_0_50px_rgba(197,160,89,0.3)]">
